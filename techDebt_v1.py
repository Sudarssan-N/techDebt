...
def summarize_results(state: AnalysisState) -> AnalysisState:
    ...
    You are a Tech Debt Analysis Agent. Given the following top issues from code analysis, generate concise recommendations to improve the repository:

    Top Issues: {top_issues}

    Provide a list of short, actionable recommendations (max 5).
    """)
    chain = prompt | llm
